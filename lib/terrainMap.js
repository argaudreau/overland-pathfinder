...
export default class TerrainMap {
    constructor(p1, p2, incline, decline) {
        this.startPoint = p1;
        this.endPoint = p2;
    ...
    get numEdges() {
        ...
        let lengths = keys.map(k => this.neighbors[k].length);
        return lengths.reduce(function(a, b) { return a + b; }, 0) / 2;
    }
    ...
    addNeighbor(node1, node2) {
        ...
        if (results.grade < this.maxIncline && results.grade > this.maxDecline) {
            gradeFactor = 50;
        }
...
//  also try and figure out what to do with elevation weights`
    ...
    getRoute() {
        ...
        return new Promise(function (resolve) {
            ...
            // Now all the shortest paths have been calculated, trace back and find the route to take
            let path = [
